...
<Box factor={.8} top={2}>
  <Img src="shorthand/gallery/I haven't seen this day before.png" classes={['shadow']} uses='ftp' alt=''/>
...
<Box factor={1} top={2}>
  <Img src="shorthand/gallery/someone tell me what to do.png" classes={['shadow']} uses='ftb' alt=''/>
  <Caption>“someone tell me what to do”</Caption>
</Box>

<Box factor={1.05} top={2}>
  <Img src="shorthand/gallery/monogram.svg" uses='ftb' alt=''/>
  <Caption>A monogram of my name</Caption>
</Box>

<Box factor={1} top={2}>
  <Img src="shorthand/gallery/appropriate.png" uses='ftb' alt=''/>
  <Caption>Many copies of the word “appropriate” woven into a pattern</Caption>
</Box>

<Box factor={.8} top={2}>
  <Img src="shorthand/gallery/geometric.png" classes={['shadow']} uses='ftb' alt=''/>
...
<Box factor={1} top={2}>
  <Img src="shorthand/gallery/mess.jpg" classes={['shadow']} uses='ftb' alt=''/>
...
<Box factor={1.05} offset={1} top={2}>
  <Img src='shorthand/gallery/experimental.png' uses='ft' alt=''/>
