...
<Img src='clapping-music/clapping music print.png' classes={["shadow"]} uses='ftpb' alt='A geometric grid of black circles and semicircles'/>
...
<Box factor={0.5}>
  <Img src='clapping-music/shift.svg' alt='' uses='f'/>
</Box>

The performer who does not shift can be seen as vertical stripes:

<Box factor={0.5}>
  <Img src='clapping-music/stay.svg' alt='' uses='f'/>
</Box>
