...
home: work
priority: 2
image: calligraphic_preview.png
draft: false
---
...
<Box factor={2} top={1} bottom={1}>
  <Img src='calligraphic.png' uses='ftpb' alt='A wide block of text in D16 Syllabics, written in a calligraphic style'/>
  <Img src='blobby.png' uses='ft' alt='A few characters in D16 Syllabics, written in a sketchy, blobby style'/>
  <Img src='monoline.png' uses='ft' alt='Three columns of text in D16 Syllabics, written in a thin, monoline style'/>
</Box>
...
<div class="media">
<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="/player.vimeo.com/video/902051722?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="D16 Syllabics"></iframe></div><script src="/player.vimeo.com/api/player.js"></script>
</div>

In this excerpt from a talk I give more detail about my process and the rationale behind the design:

<div class="media youtube">
<iframe width="1280" height="720" src="/www.youtube.com/embed/0FAtBbDBRUE?start=234&end=1058" title="Crafting Personal Alphabets: Calder Ruhl Hansen &amp; C.C. Elian (Session 2/4)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
