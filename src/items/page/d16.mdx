...
<Box factor={2} top={1} bottom={1}>
  <Img src='calligraphic.png' alt='A wide block of text in D16 Syllabics, written in a calligraphic style'/>
  <Img src='blobby.png' alt='A few characters in D16 Syllabics, written in a sketchy, blobby style'/>
  <Img src='monoline.png' alt='Three columns of text in D16 Syllabics, written in a thin, monoline style'/>
</Box>
