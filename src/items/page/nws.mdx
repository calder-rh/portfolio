...
<Box factor={3} extend={true} top={4} bottom={6}>
<Img src="intro.svg" />
</Box>
...
<Work id="nws/night"/>
<Caption>“The day with its cares and perplexities is ended and the night is now upon us”<br/>(text from Einstein on the Beach, [Knee Play 5](https://www.youtube.com/watch?v=lTaX7FQF0hY))</Caption>
