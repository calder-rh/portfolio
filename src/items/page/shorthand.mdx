...
<Box factor={0.5}>
  <Img src='instructions/introduce.svg' alt=''/>
</Box>

That spells *introduce*. Here’s how the parts correspond to letters:

<Box factor={0.5}>
<Img width={50} src='instructions/introduce letters.svg' alt=''/>
</Box>
...
<Box factor={0.5}>
<Img src='instructions/introduce directions & connections.svg' alt=''/>
</Box>
...
<Box factor={0.6}>
<Img src='instructions/introduce consonants.svg' alt=''/>
</Box>
...
<Box factor={0.8}>
<Img src='instructions/connection types slant flat.svg' alt=''/>
</Box>
...
<Img src='instructions/consonant chart.svg' alt=''/>
</Box>
...
<Img src='instructions/connection types incomplete.svg' alt=''/>
...
<Box factor={0.8}>
<Img src='instructions/angle connection try.svg' alt=''/>
</Box>
...
<Img src='instructions/connection types.svg' alt=''/>
...
<Box factor={0.9}>
<Img src='instructions/initial forms.svg' alt=''/>
</Box>
...
<Box factor={0.5}>
<Img src='instructions/verticals.svg' alt=''/>
</Box>
...
<Img src='instructions/vowels.svg' alt=''/>
...
<Box factor={0.4}>
<Img src='instructions/vowel placement.svg' alt=''/>
</Box>
...
<Box factor={0.5}>
<Img src='instructions/consecutive vowels.svg' alt=''/>
</Box>
...
<Img src='instructions/ligature chart.svg' alt=''/>
...
<Box factor={0.8}>
<Img src='instructions/ligature variation.svg' alt=''/>
</Box>
...
<Box factor={0.5}>
<Img src='instructions/edge cases.svg' alt=''/>
</Box>
...
<Img src='instructions/punctuation.svg' alt=''/>
...
<Img src='instructions/examples/however.png' alt=''/>
<Img src='instructions/examples/earlier.png' alt=''/>
<Img src='instructions/examples/question.png' alt=''/>
</Box>

Ligatures in particular become larger and more loopy:

<Box factor={0.7} offset={10}>
<Img src='instructions/examples/way.png' alt=''/>
<Img src='instructions/examples/anyone.png' alt=''/>
<Img src='instructions/examples/experience.png' alt=''/>
</Box>
...
<Box factor={0.7} offset={10}>
<Img src='instructions/examples/walk.png' alt=''/>
<Img src='instructions/examples/conversation.png' alt=''/>
</Box>

Angles become softer:

<Box factor={0.7} offset={10}>
<Img src='instructions/examples/things.png' alt=''/>
</Box>

Separate parts start to connect:

<Box factor={0.7} offset={10}>
<Img src='instructions/examples/feelings.png' alt=''/>
<Img src='instructions/examples/to.png' alt=''/>
<Img src="instructions/examples/doesn't.png" alt=''/>
</Box>
...
<Box factor={0.7} offset={10}>
<Img src='instructions/examples/imagining.png' alt=''/>
</Box>
...
<Img src='instructions/emphasize.png' alt=''/>
