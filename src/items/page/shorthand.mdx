...
home: work
slides:
  first: gallery/I haven't seen this day before_preview.png
  rest:
  - gallery/appropriate.png
  - gallery/experimental.png
  - gallery/geometric.png
  - gallery/mess.jpg
  - gallery/monogram.svg
  - gallery/someone tell me what to do.png
priority: 1
---
...
<Box factor={0.5}>
  <Img src='instructions/introduce.svg'/>
</Box>

That spells *introduce*. Here’s how the parts correspond to letters:

<Box factor={0.5}>
<Img width={50} src='instructions/introduce letters.svg'/>
</Box>
...
<Box factor={0.5}>
<Img src='instructions/introduce directions & connections.svg'/>
</Box>
...
<Box factor={0.6}>
<Img src='instructions/introduce consonants.svg'/>
</Box>
...
<Box factor={0.8}>
<Img src='instructions/connection types slant flat.svg'/>
</Box>
...
<Img src='instructions/consonant chart.svg'/>
</Box>
...
<Img src='instructions/connection types incomplete.svg'/>
...
<Box factor={0.8}>
<Img src='instructions/angle connection try.svg'/>
</Box>
...
<Img src='instructions/connection types.svg'/>
...
<Box factor={0.9}>
<Img src='instructions/initial forms.svg'/>
</Box>
...
<Box factor={0.5}>
<Img src='instructions/verticals.svg'/>
</Box>
...
<Img src='instructions/vowels.svg'/>
...
<Box factor={0.4}>
<Img src='instructions/vowel placement.svg'/>
</Box>
...
<Box factor={0.5}>
<Img src='instructions/consecutive vowels.svg'/>
</Box>
...
<Img src='instructions/ligature chart.svg'/>
...
<Box factor={0.8}>
<Img src='instructions/ligature variation.svg'/>
</Box>
...
<Box factor={0.5}>
<Img src='instructions/edge cases.svg'/>
</Box>
...
<Img src='instructions/punctuation.svg'/>
...
<Img src='instructions/examples/however.png'/>
<Img src='instructions/examples/earlier.png'/>
<Img src='instructions/examples/question.png'/>
</Box>

Ligatures in particular become larger and more loopy:

<Box factor={0.7} offset={10}>
<Img src='instructions/examples/way.png'/>
<Img src='instructions/examples/anyone.png'/>
<Img src='instructions/examples/experience.png'/>
</Box>
...
<Box factor={0.7} offset={10}>
<Img src='instructions/examples/walk.png'/>
<Img src='instructions/examples/conversation.png'/>
</Box>

Angles become softer:

<Box factor={0.7} offset={10}>
<Img src='instructions/examples/things.png'/>
</Box>

Separate parts start to connect:

<Box factor={0.7} offset={10}>
<Img src='instructions/examples/feelings.png'/>
<Img src='instructions/examples/to.png'/>
<Img src="instructions/examples/doesn't.png"/>
</Box>
...
<Box factor={0.7} offset={10}>
<Img src='instructions/examples/imagining.png'/>
</Box>
...
<Img src='instructions/emphasize.png'/>
