---
name: Recursive Prime Numeral System
description: A system that uses prime factorizations to break a number down into a visual structure
tags: [encoding-systems, itp-portfolio, mas-portfolio]
date:
  start: 2019-08-01
  end: 2020-07-26
home: work
image: 2-29 rect color.svg
priority: 1
---
...
<Box factor={1.4}>
<Img src='2-29 rect color.svg' uses='ftp' id="test" alt=""/>
</Box>
...
<Img src='shapes/A*B.svg' uses='f' id="test" alt="" scale={3}/>
...
<Img src='shapes/A*B alternate.svg' uses='f' id="test" alt="" scale={3}/>
...
<Img src='shapes/A◊1.svg' uses='f' id="test" alt="" scale={3}/>

And <Group>1 ◊ A</Group> is written as a shape enclosing nothing and touching A:

<Img src='shapes/1◊A.svg' uses='f' id="test" alt="" scale={3}/>
...
<Img src='shapes/1◊1.svg' uses='f' id="test" alt="" scale={3}/>
...
<Img src='shapes/3.svg' uses='f' id="test" alt="" scale={3}/>
...
<Img src='shapes/9.svg' uses='f' id="test" alt="" scale={3}/>
...
<Img src='shapes/8.svg' uses='f' id="test" alt="" scale={3}/>
...
<Img src='shapes/9 rect.svg' uses='f' id="test" alt="" scale={3}/>
...
<Img src='shapes/512 rect.svg' uses='f' id="test" alt="" scale={3}/>
...
<Img src='shapes/512 linear.svg' uses='f' id="test" alt="" scale={3}/>
...
<Img src='shapes/512 linear 2.svg' uses='f' id="test" alt="" scale={3}/>

One more example. Here’s one way to write 6:

<Img src='shapes/6.svg' uses='f' id="test" alt="" scale={3}/>
...
<Img src='shapes/64 rect.svg' uses='f' id="test" alt="" scale={3}/>
...
<Img src='shapes/64 linear.svg' uses='f' id="test" alt="" scale={3}/>
...
<Box factor={1}>
<Img src='2-29 rect.svg' uses='ftb' id="test" alt=""/>
</Box>
...
<Box factor={1}>
<Img src='2-29 rect color.svg' uses='ft' id="test" alt=""/>
</Box>