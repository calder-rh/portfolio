...
<Box factor={1.4}>
<Img src='2-29 rect color.svg' id="test" alt=""/>
</Box>
...
<Img src='shapes/A*B.svg' id="test" alt="" scale={3}/>
...
<Img src='shapes/A*B alternate.svg' id="test" alt="" scale={3}/>
...
<Img src='shapes/A◊1.svg' id="test" alt="" scale={3}/>

And <Group>1 ◊ A</Group> is written as a shape enclosing nothing and touching A:

<Img src='shapes/1◊A.svg' id="test" alt="" scale={3}/>
...
<Img src='shapes/1◊1.svg' id="test" alt="" scale={3}/>
...
<Img src='shapes/3.svg' id="test" alt="" scale={3}/>
...
<Img src='shapes/9.svg' id="test" alt="" scale={3}/>
...
<Img src='shapes/8.svg' id="test" alt="" scale={3}/>
...
<Img src='shapes/9 rect.svg' id="test" alt="" scale={3}/>
...
<Img src='shapes/512 rect.svg' id="test" alt="" scale={3}/>
...
<Img src='shapes/512 linear.svg' id="test" alt="" scale={3}/>
...
<Img src='shapes/512 linear 2.svg' id="test" alt="" scale={3}/>

One more example. Here’s one way to write 6:

<Img src='shapes/6.svg' id="test" alt="" scale={3}/>
...
<Img src='shapes/64 rect.svg' id="test" alt="" scale={3}/>
...
<Img src='shapes/64 linear.svg' id="test" alt="" scale={3}/>
...
<Box factor={1}>
<Img src='2-29 rect.svg' id="test" alt=""/>
</Box>
