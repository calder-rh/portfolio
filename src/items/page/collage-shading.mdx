...
<Img src='flower set.png' uses='p' alt=''/>
...
<Box factor={.4}>
  <Img src='regular cylinder.png' uses='f' alt=""/>
</Box>
...
<Box factor={.4}>
  <Img src='collage cylinder.png' uses='f' alt=""/>
</Box>
...
<Img src='placement.png' uses='f' alt=""/>
...
<Img src='bird explanation.png' uses='f' alt=""/>
