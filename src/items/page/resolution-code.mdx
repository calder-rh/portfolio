...
<Img classes={["shape-building"]} src="diagrams/shape.svg"/>
...
<Img src="diagrams/morse word 3×4.svg"/>
...
<Box factor={0.6}>
<Img src="tests/circle.png" id="circle"/>
<p id="circle-arrow">↓</p>
...
<Img classes={["shape-building"]} src="diagrams/sample shape.svg"/>
...
<Img classes={["shape-building"]} src="diagrams/iteration 1 0.svg"/>
...
<Img classes={["shape-building"]} src="diagrams/iteration 1 1.svg"/>
...
<Img classes={["shape-building"]} src="diagrams/iteration 1 2.svg"/>

We proceed to the next row: the bottom left pixel is fully white, while the bottom right needs to be split:

<Img classes={["shape-building"]} src="diagrams/iteration 1 3.svg"/>
...
<Img classes={["shape-building"]} src="diagrams/iteration 2 1.svg"/>

The second one is fully black:

<Img classes={["shape-building"]} src="diagrams/iteration 2 2.svg"/>

And so on:

<Img classes={["shape-building"]} src="diagrams/iteration 2 end.svg"/>
...
<Img classes={["shape-building"]} src="diagrams/iteration 3.svg"/>
...
<Img src="tests/1 no neighbor algorithm.png"/>
...
<Box classes={["iterations"]} factor={1.4}>
  <Img src="diagrams/blocks 1.svg"/>
  <Img src="diagrams/blocks 2.svg"/>
  <Img src="diagrams/blocks 3.svg"/>
  <Img src="diagrams/blocks 4.svg"/>
</Box>

For comparison, here are the first four iterations of the earlier shape:

<Box classes={["iterations"]} factor={1.4}>
  <Img src="diagrams/shape 1.svg"/>
  <Img src="diagrams/shape 2.svg"/>
  <Img src="diagrams/shape 3.svg"/>
  <Img src="diagrams/shape 4.svg"/>
</Box>
...
<Img classes={["shape-building"]} src="diagrams/neighbor white.svg"/>
...
<Img classes={["shape-building"]} src="diagrams/neighbor black.svg"/>

This one is touching both black and white, so it can only be <Split/>:

<Img classes={["shape-building"]} src="diagrams/neighbor both.svg"/>

And this one is touching neither black nor white (the corners don’t count), so all three options are possible:

<Img classes={["shape-building"]} src="diagrams/neighbor neither.svg"/>
...
<Img src="tests/2 neighbor but not edge.png"/>
...
<Img src="tests/3 unweighted.png"/>
...
<Img src="tests/4 fully weighted.png"/>
...
<Img src="tests/5 weight first 20.png"/>
...
<Img classes={["shape-building"]} src="diagrams/wsws.svg"/>
...
<Img classes={["shape-building"]} src="diagrams/tree.png"/>
...
<Img classes={["shape-building"]} src="diagrams/tree square 1.png"/>

But that’s not the only way to put this shape in a square frame. We could also frame it like this:

<Img classes={["shape-building"]} src="diagrams/tree square 2.png"/>
...
<Img classes={["shape-building"]} src="diagrams/tree square 3.png"/>
