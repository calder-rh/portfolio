...
<span class="rpns text-rpns inline" style="--gap: 5px;"><Prime><Text content="A"/><Text content="B"/></Prime></span> line
...
If you wanted to compact this even more, you could remove the vertical multiplication bars as they aren’t actually necessary to interpret the number — but I’ll keep them, since I think it looks nicer to have them.
...
The same structure can be represented in other ways.

<span style="font-style: regular;"><span style="padding: 0 0.5em; border: 2px solid var(--brown); margin-right: -0.1em;">A</span>B</span>