...
- **1:** a blank space
- **2:** a dot
- **the A<span class="ord">th</span> prime to the power of B:** a horizontal line with A above and B below
- **A × B:** a vertical line with A on the left and B on the right

The **nested shapes** representation works like this:

- **1:** a blank space
- **the A<span class="ord">th</span> prime to the power of B:** a shape containing A and touching B
- **A × B:** A next to B, not touching
...
<Img src='rpns/shapes/A~B.svg' uses='f' id="test" alt=""/>


<img src="/src/assets/work/rpns/shapes/1~1.svg"/>
<img src="/src/assets/work/rpns/shapes/A~B.svg"/>
