...
<Box factor={1.05} top={2}>
  <Img src="shorthand/gallery/monogram.svg" uses='ftpb' alt=''/>
...
<Box factor={.8} top={2}>
  <Img src="shorthand/gallery/geometric.png" classes={['shadow']} uses='ftpb' alt=''/>
...
<Box factor={1.05} offset={1} top={2}>
  <Img src='shorthand/gallery/experimental.png' uses='ftp' alt=''/>
