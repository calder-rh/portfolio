...
<Box factor={1.1} top={2} bottom={1.5}>
  <Img src='contour-code/sleep.png' uses='ftpb' alt=''/>
  <Caption>“Sleep”</Caption>
</Box>

<Img src='contour-code/consciousness.png' classes={['shadow']} uses='f' alt=''/>
...
I have also experimented with several other options for encodings, which use three sides for every character. One of those newer encodings is used to spell the “unconsciousness” piece above. (When I decide which I prefer I’ll add it to this page.)
